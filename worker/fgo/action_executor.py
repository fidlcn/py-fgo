...
class ActionExecutor:
    ...
    def tap_attack(self) -> None:
        self.tap_point(C.ATTACK_BUTTON)
    ...
    def tap_support_first_recommended(self) -> None:
        self.tap_point(C.SUPPORT_FIRST_RECOMMENDED)
    ...
    def tap_support_refresh(self) -> None:
        self.tap_point(C.SUPPORT_REFRESH)

    # --- results / flow -------------------------------------------------

    def tap_result_next(self) -> None:
        self.tap_point(C.RESULT_NEXT)

    def tap_quest_start(self) -> None:
        self.tap_point(C.QUEST_START_BUTTON)

    def decline_friend_request(self) -> None:
        self.tap_point(C.FRIEND_REQUEST_DECLINE)
