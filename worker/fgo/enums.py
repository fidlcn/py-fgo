...
class FgoState(str, Enum):
    ...
    ALLY_TARGET_SELECT = "ALLY_TARGET_SELECT"
    ENEMY_TARGET_SELECT = "ENEMY_TARGET_SELECT"
    MASTER_SKILL_PANEL = "MASTER_SKILL_PANEL"
    ORDER_CHANGE_SELECT = "ORDER_CHANGE_SELECT"
